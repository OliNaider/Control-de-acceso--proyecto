...
byte pin_rows[ROW_NUM] = {19, 18, 5, 17}; // GPIO18, GPIO5, GPIO17, GPIO16 connect to the row pins
byte pin_column[COLUMN_NUM] = {16, 4, 0, 2};  // GPIO4, GPIO0, GPIO2 connect to the column pins
