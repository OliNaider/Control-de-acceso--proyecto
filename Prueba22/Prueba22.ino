...
void OnDataRecv(const uint8_t *mac, const uint8_t *incomingDataBytes, int len) {  //depende la version es: const esp_now_recv_info * info, const uint8_t *incomingDataBytes, int len
